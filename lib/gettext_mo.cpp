...
gettext_mo_t::gettext_mo_t(kaitai::kstream *p__io, kaitai::kstruct *p__parent, gettext_mo_t *p__root)
...
gettext_mo_t::hash_lookup_iteration_t::hash_lookup_iteration_t(uint32_t p_idx, uint32_t p_collision_step, kaitai::kstream *p__io, kaitai::kstruct *p__parent, gettext_mo_t *p__root)
	: kaitai::kstruct(p__io) {
	m__parent = p__parent;
	m__root = p__root;
	m_idx = p_idx;
...
gettext_mo_t::lookup_iteration_t::lookup_iteration_t(hash_lookup_iteration_t *p_current, std::string_view p_query, kaitai::kstream *p__io, kaitai::kstruct *p__parent, gettext_mo_t *p__root)
	: kaitai::kstruct(p__io) {
	m__parent = p__parent;
	m__root = p__root;
	m_current = p_current;
...
gettext_mo_t::hashtable_lookup_t::hashtable_lookup_t(std::string_view p_query, uint32_t p_hash, kaitai::kstream *p__io, kaitai::kstruct *p__parent, gettext_mo_t *p__root)
	: kaitai::kstruct(p__io) {
	m__parent = p__parent;
	m__root = p__root;
	m_query = p_query;
...
gettext_mo_t::mo_t::mo_t(kaitai::kstream *p__io, gettext_mo_t *p__parent, gettext_mo_t *p__root)
	: kaitai::kstruct(p__io) {
	m__parent = p__parent;
	m__root = p__root;
	m__is_le = -1;
...
gettext_mo_t::mo_t::version_t::version_t(kaitai::kstream *p__io, gettext_mo_t::mo_t *p__parent, gettext_mo_t *p__root, int p_is_le)
	: kaitai::kstruct(p__io) {
	m__parent = p__parent;
	m__root = p__root;
	m__is_le = p_is_le;
...
gettext_mo_t::mo_t::hashtable_item_t::hashtable_item_t(kaitai::kstream *p__io, gettext_mo_t::mo_t *p__parent, gettext_mo_t *p__root, int p_is_le)
	: kaitai::kstruct(p__io) {
	m__parent = p__parent;
	m__root = p__root;
	m__is_le = p_is_le;
...
gettext_mo_t::mo_t::descriptor_t::descriptor_t(kaitai::kstream *p__io, gettext_mo_t::mo_t *p__parent, gettext_mo_t *p__root, int p_is_le)
	: kaitai::kstruct(p__io) {
	m__parent = p__parent;
	m__root = p__root;
	m__is_le = p_is_le;
