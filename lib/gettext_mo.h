  ...
  public:
	...
	class hash_lookup_iteration_t: public kaitai::kstruct {
	  ...
	  public:
		...
		uint32_t collision_step() const {
			return m_collision_step;
		}
		gettext_mo_t *_root() const {
			return m__root;
		}
	...
	class lookup_iteration_t: public kaitai::kstruct {
	  ...
	  public:
		lookup_iteration_t(hash_lookup_iteration_t *p_current, std::string_view p_query, kaitai::kstream *p__io, kaitai::kstruct *p__parent = nullptr, gettext_mo_t *p__root = nullptr);
	  ...
	  public:
		hash_lookup_iteration_t *current() const {
			return m_current;
		}
    ...
    */
	...
	class hashtable_lookup_t: public kaitai::kstruct {
	  ...
	  public:
		hashtable_lookup_t(std::string_view p_query, uint32_t p_hash, kaitai::kstream *p__io, kaitai::kstruct *p__parent = nullptr, gettext_mo_t *p__root = nullptr);
	...
	class mo_t: public kaitai::kstruct {
	  ...
	  public:
		...
		class version_t: public kaitai::kstruct {
		  ...
		  public:
			uint32_t version_raw() const {
				return m_version_raw;
			}
			gettext_mo_t *_root() const {
				return m__root;
			}
			gettext_mo_t::mo_t *_parent() const {
				return m__parent;
			}
		};
		...
		class hashtable_item_t: public kaitai::kstruct {
		  ...
		  public:
			bool _is_null_is_system_dependent() {
				is_system_dependent();
				return n_is_system_dependent;
			};
		...
		class descriptor_t: public kaitai::kstruct {
		  ...
		  public:
			uint32_t len_str() const {
				return m_len_str;
			}
			uint32_t ofs_str() const {
				return m_ofs_str;
			}
			gettext_mo_t *_root() const {
				return m__root;
	  ...
	  public:
		bool _is_null_hashtable_items() {
			hashtable_items();
			return n_hashtable_items;
		};
	  ...
	  public:
		...
		uint32_t num_translations() const {
			return m_num_translations;
		}
		uint32_t ofs_originals() const {
			return m_ofs_originals;
		}
		uint32_t ofs_translations() const {
			return m_ofs_translations;
		}
		uint32_t num_hashtable_items() const {
			return m_num_hashtable_items;
		}
		uint32_t ofs_hashtable_items() const {
			return m_ofs_hashtable_items;
		}
		gettext_mo_t *_root() const {
			return m__root;
		}
		gettext_mo_t *_parent() const {
			return m__parent;
		}
	};
